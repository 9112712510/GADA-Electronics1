                    ...
                    <form action="code.php" method="POST" enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" placeholder="Enter Catagory name" class="form-control" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" name="meta__description" placeholder="Enter Meta Description" class="form-control" required></textarea>
                        </div>
                        <div class="col-md-12">
